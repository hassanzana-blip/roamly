...
- Library: 76 variables, 18 text styles, ten component families with 32 variants, one destination-card component and three swappable SVG icon components. Input placeholder is exposed as a text property.
