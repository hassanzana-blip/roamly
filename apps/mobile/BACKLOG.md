...
| 45 | Loading and tap feedback | partial | 25 Sep: results loading shows placeholder cards in the result shape under the search, a spoken status, and «Stopp søket» at thumb reach; Reduce Motion stops the pulse (`resultsLoading.test.tsx`). Other screens: spinners remain. |
