...
export default function About() {
  ...
  return (
    <ContentPage
      ...
      intro="HelloSky er et norsk reisebyrå. Vi hjelper deg med å finne flyreiser dit du skal – strandferie, storbyhelg, langtur eller besøk hos familie og venner – med ekte mennesker på andre siden av telefonen."
    >
      <Section title="Hvem vi er">
        <p>
          ...
          den riktige billetten. Vi selger hele verden fra Norge – direktefly til europeiske storbyer, lange
          reiser med mellomlanding i Istanbul eller Gulfen, og ruter der bagasje, visum og en rolig
          mellomlanding betyr mer enn den aller korteste reisetiden. Den kunnskapen får du med deg uansett
          hvor du skal.
        </p>
      </Section>
      ...
      <div className="grid gap-3 py-7 sm:grid-cols-3">
        {[
          ...
          { icon: Heart, title: "Hele reisen, ikke bare billetten", sub: "Bagasje, mellomlanding og visum – vi hjelper deg videre" },
        ].map((c) => (
