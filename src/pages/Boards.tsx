...
/** Reisetavler – «Ibiza med gutta», «Roma med familien». Dine, med private lenker. */
    ...
    <div className="min-h-[100dvh] bg-background">
      <AppShell className="max-w-3xl">
        ...
        {list.data && list.data.length === 0 ? (
          <EmptyState icon={LayoutGrid} title="Ingen tavler ennå" body="Lag en for neste tur – «Sommer 2027», «Ibiza med gutta», «Roma med familien»." action={<PrimaryButton icon={Plus} onClick={() => setOpen(true)} className="mt-2">Ny tavle</PrimaryButton>} />
        ) : (
          <>
