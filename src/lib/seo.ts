...
export const PAGE_META = {
  ...
  notifications: { title: "Varsler", description: "Innboks og varslingsvalg.", canonicalPath: "/profil/varsler", noindex: true },
  security: { title: "Sikkerhet", description: "Innloggede enheter og passord.", canonicalPath: "/profil/sikkerhet", noindex: true },
