...
const dict = {
  ...
  "home.ask.sub": { nb: "Din neste reise starter her.", en: "Your next trip starts here.", sv: "Din nästa resa börjar här.", da: "Din næste rejse starter her.", de: "Deine nächste Reise beginnt hier." },
  "home.feel.title": { nb: "Litt nærmere feriefølelsen", en: "A little closer to holiday", sv: "Lite närmare semesterkänslan", da: "Lidt tættere på feriefølelsen", de: "Ein Stück näher am Urlaub" },
