...
const dict = {
  ...
  "home.hero.kicker": { nb: "Rutene hjem", en: "The routes home" },
  "home.hero.title": { nb: "Vi kjenner reisen hjem.", en: "We know the journey home." },
  "home.hero.body": { nb: "Til familien i Istanbul og Erbil, Beirut og Casablanca, Asmara og Islamabad. Bagasje som faktisk må være med, mellomlandinger som passer barn, og folk som svarer når noe endrer seg.", en: "To family in Istanbul and Erbil, Beirut and Casablanca, Asmara and Islamabad. Baggage that actually has to come along, layovers that work with children, and people who answer when something changes." },
