...
const dict = {
  ...
  "sr.demo": { nb: "Demomodus — priser er ikke reelle", en: "Demo mode — prices are not real" },
  ...
  "sr.alert.active": { nb: "Varslet er aktivt — vi sender e-post når prisen faller.", en: "The alert is active — we'll e-mail you when the price drops." },
