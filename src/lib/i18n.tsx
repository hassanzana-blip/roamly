...
const dict = {
  ...
  "home.h1a": { nb: "Hjem til familien.", en: "Home to family." },
  "home.h1b": { nb: "Og ut i verden.", en: "And out into the world." },
  "home.sub2": { nb: "Flyreiser fra Norge med totalpris fra første søk, bagasje som faktisk må være med, og folk som svarer på norsk – alle dager 06–24.", en: "Flights from Norway with the total price from the first search, baggage that actually has to come along, and people who answer – every day 06–24." },
  ...
  "home.routes.caption": { nb: "Rutene hjem", en: "The routes home" },
